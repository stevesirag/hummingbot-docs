...
# 3) Create folders for logs, config files and database file
mkdir hummingbot_files/hummingbot_conf
mkdir hummingbot_files/hummingbot_logs
mkdir hummingbot_files/hummingbot_data
mkdir hummingbot_files/hummingbot_scripts

# 4) Create local hummingbot user, grant ownership of files
adduser hummingbot //follow prompts, password not important
chown hummingbot:hummingbot ~/hummingbot_files/*
...
--mount "type=bind,source=$(pwd)/hummingbot_files/hummingbot_certs,target=/certs" \
